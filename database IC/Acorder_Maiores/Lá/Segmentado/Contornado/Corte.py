...
for i in range(0, 64):
    ...
    file.write(str(vet[0])+','+str(vet[1])+','+str(vet[2])+','+str(vet[3])+','+str(vet[4])+','+str(vet[5])+','+str(vet[6])+','+str(vet[7])+','+str(altura)+','+str(largura)+','+str(maior)+',C\n')
