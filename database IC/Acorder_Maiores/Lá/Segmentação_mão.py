...
for i in range(0, 64):
    ...
    while True:
        ...
        cv2.resizeWindow('imagem '+str(i), 800, 600)
        cv2.namedWindow('imagem2 '+str(i), cv2.WINDOW_NORMAL)
        cv2.imshow('imagem '+str(i), mascara)
        cv2.imshow('imagem2 '+str(i), preprocessada)
